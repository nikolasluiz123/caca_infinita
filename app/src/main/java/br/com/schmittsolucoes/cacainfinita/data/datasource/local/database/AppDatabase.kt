package br.com.schmittsolucoes.cacainfinita.data.datasource.local.database

import androidx.room.Database
import androidx.room.RoomDatabase
import androidx.room.TypeConverters
import br.com.schmittsolucoes.cacainfinita.data.datasource.local.database.access.puzzle.WordSearchPuzzleRoomDAO
import br.com.schmittsolucoes.cacainfinita.data.datasource.local.database.access.puzzle.session.PuzzleSessionRoomDAO
import br.com.schmittsolucoes.cacainfinita.data.datasource.local.database.access.puzzle.word.WordRoomDAO
import br.com.schmittsolucoes.cacainfinita.data.datasource.local.database.access.user.UserRoomDAO
...
import br.com.schmittsolucoes.cacainfinita.data.model.converters.DurationConverter
