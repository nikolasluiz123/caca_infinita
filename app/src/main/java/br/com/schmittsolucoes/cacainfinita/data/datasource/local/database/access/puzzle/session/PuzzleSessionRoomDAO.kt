...
import br.com.schmittsolucoes.cacainfinita.data.datasource.local.database.access.RoomLocalDataSource
...
interface PuzzleSessionRoomDAO: PuzzleSessionLocalDataSource, RoomLocalDataSource<PuzzleSessionEntity> {
    ...
    override suspend fun selectAllBy(puzzleId: String): List<PuzzleSessionEntity>

    @Query("select * from puzzle_session where puzzle_id = :puzzleId")
    override fun selectAllByObservable(puzzleId: String): Flow<List<PuzzleSessionEntity>>
