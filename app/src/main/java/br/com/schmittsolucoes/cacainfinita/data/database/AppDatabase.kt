package br.com.schmittsolucoes.cacainfinita.data.database

import androidx.room.Database
import androidx.room.RoomDatabase
import androidx.room.TypeConverters
import br.com.schmittsolucoes.cacainfinita.data.database.access.puzzle.WordSearchPuzzleRoomDAO
import br.com.schmittsolucoes.cacainfinita.data.database.access.puzzle.session.PuzzleSessionRoomDAO
import br.com.schmittsolucoes.cacainfinita.data.database.access.puzzle.word.WordRoomDAO
import br.com.schmittsolucoes.cacainfinita.data.database.access.user.UserRoomDAO
